package com.cyou.fz.mcms.process.common.scheduler.utils;
...
public class
    ...
    public static String DateToCronExpression(Date date, int hour, int day) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        StringBuilder cronExpression = new StringBuilder();
        cronExpression.append(calendar.get(Calendar.SECOND)).append(" ");
    ...
    public static String HourToCronExpression(String hour) {
        ...
        cronExpression.append("0").append(" ");
        cronExpression.append("0/").append(hour).append(" ");
    ...
    public static String AnalyzerTimeToCronExpression(Integer day, String startTime, Integer internal) {
        ...
        if (internal != null) {
            cronExpression.append("/").append(internal);
        }
    ...
    public static String MinutesToCronExpression(Integer minutes) {
        StringBuilder cronExpression = new StringBuilder();
        cronExpression.append("0").append(" ");
        cronExpression.append("0/").append(minutes).append(" ");
        cronExpression.append("*").append(" ");
        cronExpression.append("*").append(" ");
        cronExpression.append("*").append(" ");
        cronExpression.append("? ");//一个礼拜的第几天 可以忽略
